  ...
  <body class="o_body o_bg-white">
      ...
      <tbody>
        <tr>
          <td class="o_hide" align="center">
            Unlock your digital realm with a personalized key. Open this email
            to forge your passkey and access a world of possibilities. The
            journey starts now.
          </td>
        </tr>
      </tbody>
    ...
    >
      <tbody>
        <tr>
          <td
            class="o_bg-ultra_light o_px-md o_py-xl o_xs-py-md"
            align="center"
          >
            ...
            <div class="o_col-6s o_sans o_text-md o_text-light o_center">
              ...
              >
                <tbody>
                  <tr>
                    ...
                    >
                      <img
                        src="https://cdn-icons-png.flaticon.com/128/9178/9178566.png"
                        width="48"
                        height="48"
                        alt=""
              ...
              <p>
                We're excited to invite you to join us at
                <strong><em>${companyName}</em></strong
                >.Access exclusive opportunities and insights through our
                portal.
              </p>
            </div>
            <!--[if mso]></td></tr></table><![endif]-->
        ...
        <tr>
          <td class="o_bg-white o_px-md o_py" align="center">
            ...
            <div class="o_col-6s o_sans o_text o_text-secondary o_center">
              <p>
                To begin your journey with us, we kindly request you to generate
                a secure password for your account by clicking the button below:
              </p>
            </div>
            <!--[if mso]></td></tr></table><![endif]-->
          </td>
              ...
              <tbody>
                <tr>
                  <td
                    ...
                    align="center"
                  >
                    <a class="o_text-white" href="${url}">Set My Password</a>
                  </td>
                </tr>
              </tbody>
            </table>
    ...
    >
      <tbody>
        <tr>
          <td
            class="o_bg-white"
            style="font-size: 48px; line-height: 48px; height: 48px"
          >
            &nbsp;
          </td>
        </tr>
						  ...
						  <tbody>
							  <tr>
								  <td width="300" class="o_btn o_bg-primary o_br o_heading o_text" align="center">
									  <a class="o_text-white" href="${url}">Reset My Password</a>
								  </td>
							  </tr>
						  </tbody>
					  </table>
